  ...
  import { Github, ExternalLink, Mail, Linkedin , ArrowRight, Terminal, Coffee, Sparkles, Zap, Code, Database, Palette, Wrench, Sun, Moon, ChevronLeft, ChevronRight, Circle, Cigarette, Ticket, TicketCheck, FlaskConicalOffIcon, FlaskConical, Camera, Check } from 'lucide-react';
  ...
  const [isMobile, setIsMobile] = useState(false);
    ...
    const projects = [
      ...
      id: 8,
      title: "DataHub",
      subtitle: "a data exploration tool",
      description: "my first real database project — built it from scratch, connected everything, made it pretty, and it actually works. felt really powerful.",
      fullDescription: "DataHub is a minimal, interactive platform for exploring relational databases. Users can view tables, filter data with dropdowns, and even run custom SQL queries with live results. Built with simplicity in mind, it’s a clean UI wrapped around a powerful backend that speaks directly to an SQLite database. Designed for easy data inspection and learning.",
      tech: "full-stack · express.js · sqlite",
      techStack: ["React", "Express.js", "SQLite", "Node.js", "TailwindCSS"],
      links: {
        github: "https://github.com/anannayamustcode/receptive-satellite",
        demo: "https://receptive-satellite-production.up.railway.app/explore"
      },
      color: "bg-indigo-500",
      glowColor: "shadow-indigo-400/40",
      borderColor: "border-indigo-400/60",
...
<div className={`space-y-4 text-base sm:text-lg ${darkMode ? 'text-gray-300' : 'text-gray-600'} mb-8`}>
  ...
  {/* <p>Wanted to be an engineer long before I knew what engineers actually did</p> */}
  <p>Passionate about coding with a strong foundation in both frontend and backend — currently stepping into the world of AI/ML</p>
</div>
          ...
          <div className={`py-12 sm:py-20 border-t ${borderClasses}`}>
            <div className="flex items-center space-x-4 mb-8">
              <Check className="w-6 h-6 text-yellow-200" />
...
<p className={`text-base sm:text-lg ${darkMode ? 'text-gray-400' : 'text-gray-600'} leading-relaxed mb-6`}>
  Turns out, I love coding.  
  I chose engineering because I love math — and while there's not a ton of math here, it's still the coolest thing ever.  
  This field might just be the most random one out there.  
  Like what is: <a href="https://theuselessweb.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-indigo-500">https://theuselessweb.com/</a>.  
